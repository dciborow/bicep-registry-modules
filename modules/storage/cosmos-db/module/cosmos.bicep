...
param kind _kind = 'GlobalDocumentDB'
param properties _properties
...
output name _name = cosmosDB.name
...
type _capability = {
  name: 'EnableCassandra' | 'EnableServerless' | 'EnableTable' | 'EnableGremlin' | 'EnableMongo' | 'DisableRateLimitingResponses' | 'AllowSelfServeUpgradeToMongo36' | 'EnableAggregationPipeline' | 'MongoDBv3.4' | 'mongoEnableDocLevelTTL'
}
